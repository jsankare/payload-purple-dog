...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_users_account_status" AS ENUM('pending', 'active', 'suspended', 'rejected');
  ...
  CREATE TYPE "public"."enum_objects_category" AS ENUM('bijoux-montres', 'meubles-anciens', 'objets-art-tableaux', 'objets-collection', 'vins-spiritueux', 'instruments-musique', 'livres-manuscrits', 'mode-luxe', 'horlogerie-pendules', 'photographies-vintage', 'vaisselle-argenterie', 'sculptures-decoratifs', 'vehicules-collection');
  ...
  CREATE TABLE "objects" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"name" varchar NOT NULL,
  	"category" "enum_objects_category" NOT NULL,
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_objects_category";
